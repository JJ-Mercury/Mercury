...
pb = [random.uniform(0,1.2),random.uniform(0.8,1.1),0.7]

error = vrep.simxSetObjectPosition(clientID, ball, -1, pb, vrep.simx_opmode_blocking)
#error, p = vrep.simxGetObjectPosition(clientID, ball, -1, vrep.simx_opmode_blocking)
p=pb
